            ...
            <div class="card mb-5">
                <div class="card-header">
                    <div class="card-title d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('user.content.create') }}" class="btn btn-primary">Tambah Postingan</a>
                    </div>
                </div>                
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="{{ route('user.content.edit', $content->id) }}" class="dropdown-item">
                                                        <i class="bx bx-edit-alt me-1"></i> Edit
                                                    </a>
                                                    <form action="{{ route('user.content.destroy', $content->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
